...
export const updateShotSchema = z.object({
  ...
  holeResult: z.string().max(20).nullable().optional(),
  ...
  shotShape: z.string().max(50).nullable().optional(),
  shotResult: z.string().max(20).nullable().optional(),
  shotDetails: z.record(z.string(), z.unknown()).nullable().optional(),
